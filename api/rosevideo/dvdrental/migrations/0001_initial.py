# Generated by Django 4.2.4 on 2023-08-02 06:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FilmActor',
            fields=[
                ('actor', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dvdrental.actor')),
                ('last_update', models.DateTimeField()),
            ],
            options={
                'db_table': 'film_actor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dvdrental.customer')),
            ],
            options={
                'db_table': 'token',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField()),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dvdrental.customer')),
                ('inventory', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dvdrental.inventory')),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dvdrental.staff')),
            ],
            options={
                'db_table': 'rental',
        ...
        migrations.CreateModel(
            name='Renewal',
            fields=[
                ('renewal_id', models.IntegerField(primary_key=True, serialize=False)),
                ('new_return_date', models.DateTimeField()),
                ('rental_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dvdrental.rental')),
            ],
            options={
                'db_table': 'renewal',
            },
